...
function PromoCard({ href, title, imageUrl, eyebrow = 'Get Started' }) {
  return (
    <Link href={href} className='block border border-black/20 overflow-hidden'>
      <img
        src={imageUrl}
        alt={title || eyebrow}
      ...
      <section className='grid gap-6 lg:grid-cols-[48.72%_48.72%] lg:gap-[2.56%]'>
        <div className='space-y-4 text-[14px] leading-[1.45] text-gray-800'>
          <p className='max-w-[95%]'>
            The Paperboard Packaging Council&apos;s member-exclusive learning
            platform for the folding carton industry.
          </p>
          <p className='max-w-[95%]'>
            <strong>
              Built by and for the paperboard packaging industry, PPC University
              delivers the training your workforce needs to succeed.
            </strong>{' '}
            Whether you&apos;re onboarding new employees, developing skilled
            operators, or preparing the next generation of leaders, PPCU offers
            engaging, high-quality courses tailored to our industry&apos;s
          ...
          <ul className='list-disc space-y-1 pl-5 text-[14px]'>
            <li>
              <strong>Onboard Faster</strong> — Give new hires a strong
              foundation in the folding carton industry.
            </li>
            <li>
              <strong>Upskill with Ease</strong> — Provide your workforce with
              practical, job-ready knowledge.
            </li>
            <li>
              <strong>Lead with Confidence</strong> — Support professional
              growth and leadership development.
            </li>
            <li>
              <strong>Maximize Your Membership</strong> — Enjoy exclusive access
              and preferred pricing as a PPC member.
            </li>
          </ul>
        </div>
      ...
      <section className='border border-gray-300 bg-[#dddde1]'>
        <div className='border-b border-gray-300 px-5 py-3'>
          <h3 className='text-[17px] font-semibold leading-[1.15] text-[#1f1f1f]'>
            PPC is currently a members only benefit. Interested in learning more
            about PPCU?
          </h3>
        </div>
