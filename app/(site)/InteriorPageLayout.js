  ...
  return (
    <section className='border border-gray-300 bg-[#dddde1]'>
      ...
      <div className='space-y-3 px-5 py-4 text-[14px] leading-[1.45] text-gray-800'>
        <p>
          Access to PPC University is limited to active members of the
          Paperboard Packaging Council. We were not able to confirm an active
          membership on your account.
        </p>
        <p>
          If you believe this is an error, or would like to learn more about
          becoming a member, please reach out and we&apos;ll help sort it out.
        </p>
        <Link
